...
<img src="./RIP.assets/image-20241011220036061.png" alt="image-20241011220036061" style="zoom: 67%;" />

### 管理距离

<img src="./RIP.assets/image-20241011220834132.png" alt="image-20241011220834132" style="zoom: 80%;" />
...
<img src="./RIP.assets/image-20241011221515191.png" alt="image-20241011221515191" style="zoom: 67%;" />
...
3. 认证“password”字段被重新用于存储认证数据包长度（不含md5尾部）、密钥标识符、认证数据长度和非递减序列号seq_num。
